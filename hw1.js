...
// console.log("Currently it is"+weatherData.current.temperature+"and"+weatherData.current.conditions
// +"Tomorrow it will be"+weatherData.forecast.temperature[0]+"and"+weatherData.forecast.conditions[0]
//+"The next day we will see"+weatherData.forecast.conditions[1]+"with a temperature of"+weatherData.forecast.temperature[1]);
